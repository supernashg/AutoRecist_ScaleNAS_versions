...
class HighResolutionModule(nn.Module):
    ...
    def _init_subnet_settings(self):
        # print("self.numbraches: ", self.num_branches)
        # print("self.depthlist: ", self.depth_list)
    ...
    def sample_active_submodule(self):
        ...
        for i in range(self.num_branches):
            for j in range(max(self.depth_list)):
                # one_fusion_setting = [random.choices(fusion_candidates, weights=[1-self.fusion_percentage, self.fusion_percentage])[0]
